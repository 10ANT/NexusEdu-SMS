                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Phone:</label>
                                        <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="+18761234567" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('phone2') }}" type="text" name="phone2" class="form-control" placeholder="+18761234567" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                {{--State--}}
                                <div class="col-md-4">
                                    <label for="state_id">Parish fix: <span class="text-danger">*</span></label>
