...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'Nexus'],
            ['type' => 'system_name', 'description' => 'NexusEdu'],
            ['type' => 'term_ends', 'description' => '7/10/2024'],
            ['type' => 'term_begins', 'description' => '7/10/2024'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => 'Mandeville Town'],
            ['type' => 'system_email', 'description' => 'nexusedu@gmail.com'],
